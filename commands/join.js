...
export default {
    ...
    execute (message) {
        const java = new EmbedBuilder()
            .setColor(0x2b2d31)
            .setDescription('## How to Join Everia on **Java Edition** ⋆ ｡˚ ⋆\n' +
                            '<:f_everiadot:1322411330774241340> Open the Minecraft launcher and select **Java Edition**.\n' + 
        ...
        const bedrock = new EmbedBuilder()
            .setColor(0x2b2d31)
            .setDescription('## How to Join Everia on **Bedrock Edition** ⋆ ｡˚ ⋆\n' +
                            '<:f_everiadot:1322411330774241340> Open the Minecraft app.\n' + 
                            ...
                            '<:g_everiadot:1322411242756898826> [**Bedrock Console**](https://www.youtube.com/watch?v=6OsQtv5Nz2Y)')
            .setImage('https://i.imgur.com/8fD0ASX.png');
